...
{
    public class UpdateTaskReferenceTypeRequest
    {
    ...
    public class UpdateTaskReferenceTypeRequestValidator : AbstractValidator<UpdateTaskReferenceTypeRequest>
    {
        public UpdateTaskReferenceTypeRequestValidator()
        {
