...
{
    public class CreateTaskReferenceTypeRequest
    {
    ...
    public class CreateTaskReferenceTypeRequestValidator : AbstractValidator<CreateTaskReferenceTypeRequest>
    {
        public CreateTaskReferenceTypeRequestValidator()
        {
